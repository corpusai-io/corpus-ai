...
const alertVariants = cva(
  'relative w-full rounded-lg border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-[#171717]',
  {
    variants: {
      variant: {
        default: 'bg-white text-[#171717] border-[#E8E8E8]',
        destructive:
