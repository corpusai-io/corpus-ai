...
<footer className="text-gray-600 body-font bg-gradient-to-b from-white to-white ">
 ...
 <div className="w-64 flex-shrink-0 mx-auto text-center">
  <div className="flex flex-col items-center">
    <a className="flex title-font font-medium items-center justify-center text-gray-900 mb-1 mr-6">
      <span className="text-xl font-bold">CORPUS AI</span>
    </a>

    
    <div className="grid grid-cols-4 gap-3 mt-2">
      <a className="w-[34px] h-[34px] border-1 border-[#EAEAEA] bg-[#F3F3F5] rounded-lg  flex justify-center items-center order-4 flex-grow-0 text-gray-500 hover:text-[#BF56FF] transition" href="#">
  ...
  <div className="bg-white">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-500 text-sm text-center sm:text-left">© 2025. Corpus AI. All Rights Reserved
      </p>
