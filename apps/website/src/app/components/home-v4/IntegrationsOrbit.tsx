...
const cards: BeamCard[] = [
  { id: 'slack',     name: 'Slack',     desc: 'Channel alerts',     icon: '/socials-icons/Slack.svg',          href: '/Integrations/Slack',     side: 'left'  },
  { id: 'telegram',  name: 'Telegram',  desc: 'Bot messaging',      icon: '/socials-icons/telegram-1 1.svg',   href: '/Integrations/Telegram',  side: 'left'  },
  { id: 'whatsapp',  name: 'WhatsApp',  desc: 'Business API',       icon: '/socials-icons/whatsapp.svg',       href: '/Integrations/Whatsapp',  side: 'left'  },
  { id: 'wordpress', name: 'WordPress', desc: 'Site embedding',     icon: '/socials-icons/wordpress-icon.svg', href: '/Integrations/Wordpress', side: 'left'  },
  { id: 'zapier',    name: 'Zapier',    desc: '5,000+ automations', icon: '/socials-icons/zapier.svg',         href: '/Integrations/Zapier',    side: 'left'  },
    ...
    <section className="py-32 px-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-wrap justify-center gap-3 mt-12">
        {[
          ...
          { name: 'Telegram',      href: '/Integrations/Telegram' },
