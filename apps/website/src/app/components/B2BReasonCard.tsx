...
export default function B2BReasonCard({ icon, title, description }: B2BReasonCardProps) {
  return (
    <div className="bg-white group rounded-2xl border-2 border-zinc-100 p-6 flex flex-col min-w-[220px] min-h-[160px] transition shadow-sm hover:shadow-md hover:ring-purple-200 hover:border-purple-300">
