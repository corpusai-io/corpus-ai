...
export default function ChatBotBlog({title, date, description, downTagText}: ChatBotBlog){
    return(
       <div className="box w-full  max-w-6xl rounded-xl border shadow border-gray-100 p-4 flex flex-col gap-2 group">
        <div className="top flex justify-between gap-4">
            <p className="text-[#BF56FF] ml-2">Chatbot</p>
            <p>{date}</p>
        </div>
