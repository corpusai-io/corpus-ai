...
const features = [
  {
    ...
    description: 'By integrating with enterprise systems, AI chatbots can speed up daily approval processes, such as procurement requests and expense reimbursements, reducing human delays.',
    highlight: false,
  },
  {
    icon: (
    ...
    description: `Internal chatbots can quickly respond to requests like password resets, software installations, network issues, and more, significantly reducing the IT team's workload and improving response times.`,
    highlight: true,
  },
  {
    icon: (
 ...
 <path d="M22 21V19C22 17.1362 20.7252 15.5701 19 15.126M15.5 3.29076C16.9659 3.88415 18 5.32131 18 7C18 8.67869 16.9659 10.1159 15.5 10.7092M17 21C17 19.1362 17 18.2044 16.6955 17.4693C16.2895 16.4892 15.5108 15.7105 14.5307 15.3045C13.7956 15 12.8638 15 11 15H8C6.13623 15 5.20435 15 4.46927 15.3045C3.48915 15.7105 2.71046 16.4892 2.30448 17.4693C2 18.2044 2 19.1362 2 21M13.5 7C13.5 9.20914 11.7091 11 9.5 11C7.29086 11 5.5 9.20914 5.5 7C5.5 4.79086 7.29086 3 9.5 3C11.7091 3 13.5 4.79086 13.5 7Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    ...
    description: 'Employees can query salary and vacation policies, submit leave applications, and get quick support through the HR chatbot, streamlining workforce management.',
    highlight: false,
  },
  {
    icon: (
 ...
 <path d="M14 2.26953V6.40007C14 6.96012 14 7.24015 14.109 7.45406C14.2049 7.64222 14.3578 7.7952 14.546 7.89108C14.7599 8.00007 15.0399 8.00007 15.6 8.00007H19.7305M16 18.5L14.5 17M14 2H8.8C7.11984 2 6.27976 2 5.63803 2.32698C5.07354 2.6146 4.6146 3.07354 4.32698 3.63803C4 4.27976 4 5.11984 4 6.8V17.2C4 18.8802 4 19.7202 4.32698 20.362C4.6146 20.9265 5.07354 21.3854 5.63803 21.673C6.27976 22 7.11984 22 8.8 22H15.2C16.8802 22 17.7202 22 18.362 21.673C18.9265 21.3854 19.3854 20.9265 19.673 20.362C20 19.7202 20 18.8802 20 17.2V8L14 2ZM15.5 14.5C15.5 16.433 13.933 18 12 18C10.067 18 8.5 16.433 8.5 14.5C8.5 12.567 10.067 11 12 11C13.933 11 15.5 12.567 15.5 14.5Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    ...
    title: 'Internal Knowledge Control',
    description: 'The enterprise chatbot enables smart retrieval of policy documents, guides, and training materials, helping employees quickly access information for better performance and decisions.',
    highlight: false,
  },
  {
    icon: (
    ...
    description: 'The sales and marketing team can gain quick access to customer profiles, product information, sales data, and automatic report generation to help grow your business.',
    highlight: false,
  },
];
...
const reasons = [
  {
    ...
    description: 'AI chatbot uses ML and NLP to understand employee intent, handle conversations, and improve responses.'
  },
  {
   icon: (
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-chart-line h-6 w-6 text-[#BF56FF]" aria-hidden="true"><path d="M3 3v16a2 2 0 0 0 2 2h16"></path><path d="m19 9-5 5-4-4-3 3"></path></svg>
    ...
    description: 'Corpus AI analyzes interaction data in real time to deliver precise insights that help to optimize operations and decisions.'
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-settings h-6 w-6 text-[#BF56FF]" aria-hidden="true"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"></path><circle cx="12" cy="12" r="3"></circle></svg>
    ...
    description: "Corpus chatbot integrates with IT, HR, finance, and operations platforms for seamless data flow and process optimization."
  },
  {
    icon: (
    ...
    description: "With auto-translation and multi-language support, Our chatbots let global employees easily access policies, IT, and HR services with ease"
  },
  {
    icon: (
      <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="lucide lucide-chart-line h-6 w-6 text-[#BF56FF]">
 ...
 <path d="M12 14C13.1046 14 14 13.1046 14 12C14 10.8954 13.1046 10 12 10C10.8954 10 10 10.8954 10 12C10 13.1046 10.8954 14 12 14Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    ...
    description: 'Our AI is a no-code chatbot platform enabling HR, IT, and management to customize and manage replies easily—no coding required.'
  },
  {
    icon: (
...
<br />
 ...
 <br />for
 <span className="text-transparent bg-clip-text font-semibold bg-gradient-to-r from-[#BF56FF] via-[#D0A8E9] to-[#BF56FF]"> Seamless Workplace Operations
</span>
              </h1>
              <p className="text-[#7F7A7A] mb-8 text-base sm:text-lg">
                Boost efficiency with our AI chatbot—enhancing employee support, knowledge management, and streamlining processes for a smoother, more productive workplace.
              </p>
         ...
         <section data-aos="fade-up" data-aos-duration="500" className="w-full flex flex-col items-center mt-20 mb-20 max-w-7xl mx-auto">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-[#000000] text-center mb-12">Why Choose Corpus Internal Chatbot?</h2>
        ...
        <section data-aos="fade-up" data-aos-duration="500" className="w-full flex flex-col items-center pl-7 pr-2 justify-center  mt-20 mb-10 mx-auto max-w-7xl">
          ...
          <div className="flex flex-col lg:flex-row md:justify-between items-center justify-center w-full  gap-10">
            ...
            <img className='order-2 lg:order-1 lg:w-1/2' src="/assets/workspace 1.png" alt="" />
            {/* Right: Setup Info */}
            <div className="flex-1 flex flex-col items-start justify-center mb-10 lg:mb-0 order-1">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold text-zinc-900 mb-3">Seamless Integration & Customization</h3>
              <p className="text-zinc-500 text-base sm:text-lg">The Corpus AI internal chatbot starts with seamless integration with your enterprise systems, ensuring access to all relevant data and customization to optimize workflows for your specific needs.</p>
            </div>
          </div>
        </section>
        ...
        <section data-aos="fade-left" data-aos-duration="500" className="w-full overflow-x-hidden pl-7 pr-2 flex flex-col lg:flex-row items-center justify-center mt-2 mb-10 max-w-7xl mx-auto">
          ...
          <div className="flex-1 flex flex-col items-start justify-center mb-10 lg:mb-0">
            ...
            <h3 className="text-2xl sm:text-3xl font-bold text-zinc-900 mb-3">AI-Powered Interactions & <br/>Intelligent Responses</h3>
            <p className="text-zinc-500 text-base sm:text-lg">Through machine learning and NLP, Corpus AI enables intelligent interactions, quickly identifying and accurately responding to employee needs and optimizing daily workflows.
</p>
          </div>
          {/* Right: Image Card */}
          <div className="flex-1 flex items-center justify-center">
            <img src="/assets/workspace 2.png" alt="Chatbot Build Status" className="w-full" />
          </div>
        </section>
...
>
  ...
  <div className="flex-1 flex flex-col items-start justify-center mb-10 lg:mb-0">
    ...
    <h3 className="text-2xl sm:text-3xl font-bold text-zinc-900 mb-3">Continuous Learning & <br/>Performance Optimization</h3>
    <p className="text-zinc-500 text-base sm:text-lg">
     Corpus AI is constantly learning from employee interactions and optimizing performance with real-time data to ensure enterprise chatbots adapt to changes in the workplace and continue to improve overall operational efficiency.
    </p>
  </div>
  ...
  {/* Image second in DOM */}
      ...
      />
        ...
        <h1 className="text-xl sm:text-2xl md:text-5xl font-medium text-[#1E1E1E] leading-tight">
         Ready to Transform <br/><span className="bg-gradient-to-r from-[#DAC0FF] to-[#BF56FF] bg-clip-text text-transparent"> your internal operations?</span>
        </h1>
