  ...
  return (
    <>
      <main className="flex-1 flex">
        <div className="w-full max-w-auto  overflow-x-hidden">
          ...
          <div className="mt-4 bg-[#fff] p-[20px] rounded-[10px] ">
            ...
            <div className="mt-4 border-1 border-[#EAEAEA] pb-[40px] rounded-[10px] max-w-auto">
              ...
              <div className="mt-3 border-t border-[#EAEAEA] pl-[22px] pt-[10px]">
                ...
                <div className="flex items-center flex-wrap gap-2 cursor-pointer">
                  <div className="flex items-center gap-21 py-1 px-3 bg-[#fff] rounded-[7px] border border-[#EAEAEA]">
                ...
                <div className="flex text-[12px] text-[#110a0a] mt-2">
                  <div className="bg-[#fff] px-[10px] py-[10px] space-y-1.5 rounded-[7px] border border-[#EAEAEA] text-[#7F7F7F] max-w-full mb-[-120px] z-11">
                  ...
                  <p className="pt-2 pl-3 pr-3 text-wrap break-words text-[#7F7F7F]">
            ...
            <div className="mt-4 border-1 border-[#EAEAEA] rounded-[10px] text-[12px] pt-[26px]">
              <p className="pl-[22px] text-[#7F7F7F]">Corpus's RESTful API provides a oroarammable interface to our chatbot. You can use it to build public or private apps, workflows, and integrations ontop or Corpus.</p>

              <div className="mt-[4px] text-[#BF56FF] font-bold pl-[23px]">API Documentation</div>
              ...
              <div className="mt-4 pt-[80px] border-[#EAEAEA] border-t-1 text-center ">
                ...
                <div>
                  <button className="bg-[#BF56FF] border-1 border-[#EAEAEA] rounded-[5px] py-[5px] px-[10px] mt-[40px] mb-[8px] mx-auto  text-[#fff] ml-[600px] cursor-pointer">Generate API Key</button>
                </div>
              </div>
