...
export default function WebsiteReasons() {
  return (
    ...
    <div className="bg-white py-10 mt-6">
       <h1 className="font-bold text-[30px] px-5 b-10 lg:text-center text-left">Why Choose CorpusAI Website Chatbot</h1>
            ...
            <div className="space-y-4 border-1 border-[#EEEEEE] rounded-[10px] p-4 hover:text-[#BF56FF] hover:border-[#BF56FF] cursor-pointer hover:shadow-[0_0_25px_rgba(127,17,224,0.2)]">
                ...
                <div className='space-y-1'>
                    ...
                    <p className='text-[#7D7D7D] text-[13px]'>
                        Powered by state-of-the-art RAG models, our chatbot provides more accurate and contextual responses than traditional chatbots.
                    </p>
                </div>
            </div>
            ...
            {/* Card 2 Code start here */}
              <div className="space-y-4 border-1 border-[#EEEEEE] rounded-[10px] p-4 hover:text-[#BF56FF] hover:border-[#BF56FF] cursor-pointer hover:shadow-[0_0_25px_rgba(127,17,224,0.2)]">
                ...
                <div className='space-y-2'>
                    ...
                    <p className='text-[#7D7D7D] text-[13px]'>
                        Supports 80+ languages with auto-detection and natural responses for global websites.
                    </p>
                </div>
            </div>
            ...
            {/* Card 3 Code start here */}
              <div className="space-y-4 border-1 border-[#EEEEEE] rounded-[10px] p-4 hover:text-[#BF56FF] hover:border-[#BF56FF] cursor-pointer hover:shadow-[0_0_25px_rgba(127,17,224,0.2)]">
                ...
                <div className='space-y-2'>
                    ...
                    <p className='text-[#7D7D7D] text-[13px]'>
                        Get real-time responses without hold times or digging through FAQs—our chatbot ensures fast, efficient support.
                    </p>
                </div>
            </div>
            ...
            {/* Card 4 Code start here */}
              <div className="space-y-4 border-1 border-[#EEEEEE] rounded-[10px] p-4 hover:text-[#BF56FF] hover:border-[#BF56FF] cursor-pointer hover:shadow-[0_0_25px_rgba(127,17,224,0.2)]">
                ...
                <div className='space-y-2'>
                    ...
                    <p className='text-[#7D7D7D] text-[13px]'>
                        Track your chatbot's performance, analyze user interactions, and gain insights to optimize your customer service strategy.
                    </p>
                </div>
            </div>
            ...
            {/* Card 5 Code start here */}
              <div className="space-y-4 border-1 border-[#EEEEEE] rounded-[10px] p-4 hover:text-[#BF56FF] hover:border-[#BF56FF] cursor-pointer hover:shadow-[0_0_25px_rgba(127,17,224,0.2)]">
                ...
                <div className='space-y-2'>
                    ...
                    <p className='text-[#7D7D7D] text-[13px]'>
                       Add our chatbot to your website with a simple copy-paste of a code snippet, or use our integrations for platforms like WordPress and Shopify.
                    </p>
                </div>
            </div>
