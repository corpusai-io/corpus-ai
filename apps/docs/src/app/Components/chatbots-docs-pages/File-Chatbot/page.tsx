...
import AddChatbot from "./File-Pages/Website-chatbot-add-code";
import Process from "./File-Pages/File-chatbot-Ask-Q";
import ChatbotGuide from "./File-Pages/CHatbot-Guide";
import WebsiteReasons from './File-Pages/Website-Reason';
import WebsiteFeatures from './File-Pages/Website-Features';
import WebsiteChatbotDesign from "./File-Pages/website-chatbot";
import FAQ from "./File-Pages/Website-FAQ";
import AnimatedSection from "./AnimatedSection";


export default function WebsiteChatbot(){
  const [activeSection, setActiveSection] = useState<'file' | 'web'>('file');
...
useEffect(() => {
  ...
  <main className="flex-1 flex">
            ...
            <h2  className="font-bold  mt-1 text-[20px] dark:text-white">File Chatbot</h2>
          ...
          <div className="flex gap-5 mt-3">
                ...
                <ul className="space-y-2 text-sm font-medium w-40">
                  <li>
                    <button
                      onClick={() => {
              if (!fileTabLocked) setActiveSection('web');
            }}
