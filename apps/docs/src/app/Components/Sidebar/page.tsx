...
export default function Page() {
  ...
  return (
    ...
    <div className="w-70 h-screen bg-white">
      <nav>
       ...
       <ul className="mt-2 ml-3 space-y-2 text-sm text-gray-700">
  ...
  <li>
    ...
    <div className="pl-6 mt-1 border-l border-gray-300 text-gray-500 space-y-1 pr-3 ml-3">
      <Link href="/Install-ON" className="flex justify-between">Install On  <img src="/Website Assets/Arrow Left.svg" alt="" /></Link>
