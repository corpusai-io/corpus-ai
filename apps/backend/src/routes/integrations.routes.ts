...
router.post('/slack/:chatbotId', authenticateToken, connectSlack);
router.delete('/slack/:chatbotId', authenticateToken, disconnectSlack);

// ========== ZAPIER ==========
router.post('/zapier/subscribe', authenticateToken, zapierSubscribe);
...
router.post('/google-drive/:chatbotId', authenticateToken, connectGoogleDrive);
router.delete('/google-drive/:chatbotId', authenticateToken, disconnectGoogleDrive);

// ========== TELEGRAM ==========
router.post('/telegram/:chatbotId', authenticateToken, connectTelegram);
router.delete('/telegram/:chatbotId', authenticateToken, disconnectTelegram);

// ========== WHATSAPP ==========
router.post('/whatsapp/:chatbotId', authenticateToken, connectWhatsApp);
